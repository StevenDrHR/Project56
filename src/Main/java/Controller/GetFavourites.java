...
public class GetFavourites {
    ...
    public ArrayList<String> getFavourites(String userid) throws SQLException {
        ...
        String Querry = "Select p.brand, p.modal, p.car_type, p.price from products p, favourites f where p.productid = f.productid and f.userid = "+userid; //Getting all the favorites of an user
