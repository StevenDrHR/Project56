...
public class GetOrderHistory {
    ...
    public ArrayList GetOrderHistory(String userid) throws SQLException {
        ...
        String Querry = "Select  op.orderid , op.amount , op.productid from orders_products op,orders o where op.orderid = o.orderid and o.userid = "+userid+";";//Getting the order history of an user
